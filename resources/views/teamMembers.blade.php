              ...
              <div class="white_shd full margin_bottom_30">
                ...
                <div id="edit_errList"></div>
                 ...
                 <div class="container mb-5 collapse" id="collapseExample">
                   <form action="{{route('admin_add_new_teamMember_for_club')}}" method="post" enctype="multipart/form-data">
                     @csrf
                  <div class="row">
                       ...
                       <table class="table">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="{{url('club/teamMember/delete')}}/{{$player->team_player_id}}" class="btn btn-danger m-1 "><i class="fa fa-trash"></i></a>
                                  </td>
                              </tr>
                              @php
                                   $i++;
