            ...
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        ...
                        <div>
                        <div class="small text-gray-500">{{dateFormat($noti->created_at)}}</div>
                        <span class="font-weight-bold">{{$noti->noti_title}}</span><br>
                    ...
                    <a class="dropdown-item text-center small text-gray-500" href="{{url('admin/notifications')}}">Show All Alerts</a>
                </div>
            </li>
